...
public class RobotContainer {
  ...
  private final SwerveSubsystem drivebase = new SwerveSubsystem(
      new File(Filesystem.getDeployDirectory(), "swerve/robot"));
  ...
  private void configureBindings() {
    ...
    if (DriverStation.isTest()) {
      ...
      // coralEnter.and(coralExit.negate()).and(coralHopper.negate()).onTrue(lights.set(Lights.Colors.RED,
      // Lights.Patterns.FAST_FLASH));
      // coralHopper.and(coralExit.negate()).onTrue(lights.set(Lights.Colors.RED,
      // Lights.Patterns.MARCH));
