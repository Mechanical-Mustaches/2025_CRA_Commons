...
// public Climber() {
// initialized = false;
// motor = new SparkMax(Constants.Climber.MOTOR,
...
// motor.configure(leverMotorConfig, SparkBase.ResetMode.kResetSafeParameters,
// SparkBase.PersistMode.kPersistParameters);
// armFeedforward = new ArmFeedforward(Constants.Climber.KS,
// Constants.Climber.KG, Constants.Climber.KV);
...
// climberDutyCycle = climberPID.calculate(armEncoder.getPosition(),
// requestedPosition) + gravityDutyCycle;
